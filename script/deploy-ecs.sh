...
usage="Usage: deploy-ecs.sh [xcurrency-app-web|xcurrency-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/xcurrency:$2"
...
aws ecs update-service --cluster xcurrency \
  --no-cli-pager \
  --region "$ecs_region" \
